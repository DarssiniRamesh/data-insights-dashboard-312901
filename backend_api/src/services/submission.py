...
class SubmissionService:
    ...
    def create_submission(
        ...
        Args:
            ...
            actor_user_id: User submitting
            actor_role: Role of the actor
            correlation_id: Request correlation ID
            
        Returns:
            Dict with submission_id, package_id, package_version, state, created_at_utc, audit_event_id
            
        Raises:
            ValueError: If draft not found or invalid state
        ...
        try:
            ...
            self.db.execute(
                ...
                """,
                (
                    submission_id, draft_id, draft["package_id"], draft["package_version"],
                    state, actor_user_id, created_at_utc, created_at_utc, None
                )
            )
            
            # Create validation pipeline job
